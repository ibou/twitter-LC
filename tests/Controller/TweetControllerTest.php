...
class TweetControllerTest extends TestCase
{
    ...
    private TweetModelInterface $tweetModel;
    
    protected function setUpMySqlDb(): TweetModelInterface
    {
        $this->pdo = new \PDO(
            'mysql:host=localhost;dbname=tweetters;charset=utf8',
            'root',
            'root',
    ...
    protected function setUpJsonDb(): TweetModelInterface
    {
    ...
    public function testAUserCanSaveTweet()
    {
     ...
     */
    public function TestItCantSaveTweetIfFieldsAreMissing($postData, $errorMessage)
    {
    ...
    public function we_can_delete_a_tweet_with_its_id()
    {
        ...
        $tweetId = $this->tweetModel->save("Ibou", "Un tweet de test");
        ...
        $tweet = $this->tweetModel->findById($tweetId);
    ...
    public function we_can_see_a_tweet_with_its_id()
    {
        ...
        $tweetId = $this->tweetModel->save("Ibou", "Un tweet");
        ...
        $this->assertStringContainsString('Ibou', $response->getContent());
